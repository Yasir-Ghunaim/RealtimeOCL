...
################################################################################
"""
This is a modified version of the original Avalanche benchmark for CIFAR10.
...
def SplitCIFAR10(
    ...
    *,
    ...
    """
    cifar_train, cifar_test, cifar_valid = _get_cifar10_dataset(dataset_root, indexed=indexed)
    if validation:
...
def _get_cifar10_dataset(dataset_root, indexed=False):
    if dataset_root is None:
        dataset_root = default_dataset_location("cifar10")

    full_set = CIFAR10(dataset_root, train=True, download=True)
